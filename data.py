...
parser.add_argument(
    "--real_dir", type=str, required=True, help="Directory to save real images."
)
parser.add_argument(
    "--aigen_dir",
    type=str,
    required=True,
    help="Directory to save AI-generated images.",
)
parser.add_argument(
    "--num_img", type=int, required=True, help="Number of image pairs required"
)
