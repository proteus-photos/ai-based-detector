...
def compute_metrics(data_dir, output_csv, metrics_fun):
    ...
    list_algs = [_ for _ in table.columns if _!='path'] #list of all algorithms or models used
    table = prepare_data(data_dir).merge(table, on=['path', ])
...
if __name__ == "__main__":
    ...
    tab_metrics = compute_metrics(args['data_dir'], args['out_csv'], dict_metrics[args['metrics']])
