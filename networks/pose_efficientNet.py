# -----------------
# Modified to get just class prediction probablities
# -------------------
...
from .common import InceptionBlock, conv_block, BN_MOMENTUM, SELayer
...
class EfficientNet(nn.Module):
                        ...
                        if idx + 1 < n_deconv:
                            ...
                            if self._global_params.use_c2:
                                self.conv_c2 = conv_block(
                                    32, out_decod_filters, (3, 3), stride=1, padding=1
                                )
                    if self.se_layer:
    ...
    def forward(self, inputs):
        ...
        if self._global_params.include_hm_decoder:
            ...
            return torch.clamp(self._sigmoid(ret["cls"]), min=1e-4, max=1 - 1e-4)
