...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Train SVM on top of other clip encoders"
    )
    parser.add_argument(
        "--data_dir",
        type=str,
        default="data/trainsvm",
    ...
    parser.add_argument(
        "--infer", action="store_true", help="Used for inference, csv output of logits"
    )
...
def main():
    ...
    models_dict, transforms_dict = initialize_models(
        model_list, device, args.postprocess, args.next_to_last
    )
